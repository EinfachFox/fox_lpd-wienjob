print("^0======================================================================^7")
print("^0[^1EinfachFox:^0] ^7:^0 ^3ist der Beste^7")
print("^0[^4Discord:^0]^0 ^7https://discord.gg/c7NrQVVraD")
print("^0======================================================================^7")
...
function setUniform(uniform, playerPed)
	TriggerEvent('skinchanger:getSkin', function(skin)
		...
		if uniformObject then
			...
			if uniform == 'wega_weste' or uniform == 'cobra_weste' or uniform == 'wegastich_weste' or uniform == 'stich_weste'then
...
function OpenCloakroomMenu()
	...
	local elements = {
		{label = '--Zivi---', uniform = 'zivi_wear'},
		{label = _U('citizen_wear'), value = 'citizen_wear'},
		{label = '---Jacke---', uniform = 'jackka_weste'},
		{label = 'LPD - Jacke', uniform = 'lpd_jacke'},
		{label = '---WESTEN---', uniform = 'westen_wear'},
		{label = 'WEGA WESTE', uniform = 'wega_weste'},
		{label = 'WARNWESTE', uniform = 'warn_weste'},
		{label = 'WEGA-STICHWESTE', uniform = 'wegastich_weste'},
		{label = 'COBRA WESTE', uniform = 'cobra_weste'},
		{label = 'STICHWESTE', uniform = 'stich_weste'},
		{label = '---LPD', uniform = 'lpd'},
		{label = 'LPD - Uniform', uniform = 'lpd_wear'},
                {label = 'Libelle - Uniform', uniform = 'libelle_wear'},
		{label = '---LVA---', uniform = 'lvavv_weste'},
		{label = 'LVA - LEITUNG KURZARM', uniform = 'lpdleitung_wear'},
		{label = 'LVA - LEITUNG LANGARM', uniform = 'lpdleitunglang_wear'},
		{label = 'LVA - Uniform', uniform = 'lva_wear'},
		{label = '---LKA---', uniform = 'lkawew_weste'},
		{label = 'LKA - LEITUNG', uniform = 'lkaleitung_wear'},
		{label = '---ASE---', uniform = 'ase'},
		{label = 'WEGA - Uniform', uniform = 'wega_uni'},
		{label = 'COBRA - Uniform', uniform = 'cobra_uni'},
		{label = 'COBRA - LEITUNG', uniform = 'cobra_wear'},
		{label = 'WEGA - LEITUNG', uniform = 'wegas_wear'},
		{label = '---General---', uniform = 'leitung_weste'},
		{label = 'General - Langarm', uniform = 'langgeneral_wear'},
		{label = 'General - Kurzarm', uniform = 'kurzgeneral_wear'}
	}
	...
	if data.current.value == 'citizen_interaction' then
		...
		elseif data.current.value == 'object_spawner' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				align    = 'top-left',
				elements = {
                                        {label = ('H�tchen'), model = 'prop_roadcone02a'},
                                        {label = ('Gro�es H�tchen'), model = 'prop_roadcone01b'},
                    			{label = ('POLIZEIABSPERRUNG'), model = 'prop_barrier_work05'},
                   			{label = ('Nagelband'), model = 'p_ld_stinger_s'},
                    			{label = ('Orangene Barriere'), model = 'prop_plas_barier_01a'},
                    			{label = ('Standlicht'), model = 'prop_worklight_03b'},
                    			{label = ('Kleines Licht'), model = 'prop_worklight_02a'},
                    			{label = ('DEMOABSPERRUNG'), model = 'ba_prop_battle_barrier_02a'},
                    			{label = ('ZELT'), model = 'prop_gazebo_02'},
                    			{label = ('Tisch'), model = 'v_ilev_liconftable_sml'},
                    			{label = ('Sessel'), model = 'v_ilev_chair02_ped'},
                    			{label = ('T�terscheibe'), model = 'gr_prop_gr_target_04a'},
                    			{label = ('Geiselscheibe'), model = 'gr_prop_gr_target_04b'}
			}}, function(data2, menu2)
				local playerPed = PlayerPedId()
...
AddEventHandler('esx_policejob:hasEnteredEntityZone', function(entity)
	...
	if GetEntityModel(entity) == GetHashKey('p_ld_stinger_s', 'prop_plas_barier_01a' ) then
		local playerPed = PlayerPedId()
		local coords    = GetEntityCoords(playerPed)
